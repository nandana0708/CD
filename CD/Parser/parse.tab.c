...
int tempVarCounter = 0; // Define tempVarCounter
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MAIN_KEYWORD = 12,              /* MAIN_KEYWORD  */
  ...
  YYSYMBOL_LESS_THAN_OR_EQUAL = 20,        /* LESS_THAN_OR_EQUAL  */
  YYSYMBOL_GREATER_THAN = 21,              /* GREATER_THAN  */
  YYSYMBOL_GREATER_THAN_OR_EQUAL = 22,     /* GREATER_THAN_OR_EQUAL  */
  YYSYMBOL_ADD = 23,                       /* ADD  */
...
static const char *const yytname[] =
{
  ...
  "FLOAT_TYPE", "BOOL_TYPE", "STRING_TYPE", "IF", "ELSE", "WHILE", "FOR",
  "PRINT", "MAIN_KEYWORD", "INTEGER", "FLOAT", "BOOLEAN", "STRING",
  "EQUAL", "NOT_EQUAL", "LESS_THAN", "LESS_THAN_OR_EQUAL", "GREATER_THAN",
  "GREATER_THAN_OR_EQUAL", "ADD", "SUBTRACT", "MULTIPLY", "DIVIDE",
  "ASSIGN", "LEFT_PAREN", "RIGHT_PAREN", "LEFT_BRACE", "RIGHT_BRACE",
  "SEMICOLON", "IDENTIFIER", "UNKNOWN", "'+'", "'-'", "'*'", "'/'",
  "\"||\"", "\"&&\"", "'('", "')'", "$accept", "program",
  "declaration_list", "compound_statement", "statement_list", YY_NULLPTR
};
...
void yyerror(const char* s) {
    cout << "Parse error: " << s << " at line " << line_number << endl;
    exit(1);
}
